...
"""Tilrettelegger modul for DAB og nettradio - versjon med trÂder for hver av utkanalene"""
...
maxVent = 55 # Timeout tid på trådene
quark = "dab:ny"
...
def start_utspiller(innstikkNavn=None, innstikkType=None, parametre = {}, returMeldinger = None):
    "Enhet som startes som en trÂd og som laster riktig utspillingsenhet"
    ...
    if dok:
        for krav in parsere:
            ...
            if iBane.pathInXml:
                ...
                #Siden vi aldri fÂr match pÂ mer en en type kan vi avbryte nÂ
                break
...
if (__name__=='__main__'):
        ...
        if not ('*' in allow or fra in allow):
            ...
            try:				
                ...
                #Alfa kan enten vÊre en OK eller en feilmelding som er hÂndtert av systemet
