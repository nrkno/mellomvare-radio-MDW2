	...
	for kanal in kanaler:
		...
		for kanal in distriktskanaler:
			...
			for blokk in visningsvalgBlokk:
				...
				#Spesialtilfelle for Pushmeldinger N/A
				"""
				if len(sk) == 1 and levetid < 70 and 'iteminfo' in oppdateres:
				...
				"""
				for addr in ["icecast01.dmz.nrk.no","icecast02.dmz.nrk.no", "160.68.176.39","icecast03.dmz.nrk.no"]:
...
if __name__=='__main__':
	tilDab(kanal='mpetre',datatype='iteminfo')
